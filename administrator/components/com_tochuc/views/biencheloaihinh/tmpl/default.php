...
<div class="row-fluid">
	<div class="span6">
<fieldset>
<legend>Danh sách Biên chế loại hình
		...
		<table class="table table-striped table-bordered table-hover">
			...
			for ($i = 0; $i < count($this->items); $i++) {
				...
				<tr>
					...
					<td nowrap="nowrap">						
						<a href="index.php?option=com_tochuc&controller=biencheloaihinh&task=delete&id=<?php echo $item['id'];?>" class="btn btn-danger btn-mini"><i class="icon-trash"></i></a>
					</td>
				</tr>
				<?php 
			} 
	...
	<div class="span6" id="form-content">
...
jQuery(document).ready(function($){
	var _initEditPage = function(id){
		$.get('index.php?option=com_tochuc&controller=biencheloaihinh&task=edit&format=raw',{"id":id},function(response){
