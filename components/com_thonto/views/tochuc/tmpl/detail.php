...
<div class="tabbable" id="tabs">
	...
	<div class="tab-content">
		...
		<?php
			if ($this->row->kieu == 4 || $this->row->kieu == 5) {
// 4,5 Thôn tổ
				?>
				<fieldset>
...
// 3 Phường
				...
				<?php 
			}else if ($this->row->kieu == 1 || $this->row->kieu == 2) {
// 12 Vỏ chứa, quận huyện
		?>
				<legend>Thông tin chung</legend>			
				<table width="100%">
					<tbody>
...
jQuery(document).ready(function($){
	$('#btnXoaThonto').on('click',function(){
		if(confirm("Bạn có muốn xóa không?")){
			if(confirm("Bạn có muốn xóa Tổ dân phố/Thôn này không?")){
		  				jQuery.ajax({
			  				  type: "GET",
