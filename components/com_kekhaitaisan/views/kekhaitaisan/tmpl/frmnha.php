...
<div class="row-fluid">
	<div class="span6">
		<div class="control-group">
			<label class="control-label">Loại nhà (<span style="color:red;">*</span>)</label>
			<div class="controls">
				<?php echo $this->cboloainha;?>
			</div>
		</div>
	</div>
	<div class="span5">
		<div class="control-group">
			<label class="control-label">Cấp công trình (<span style="color:red;">*</span>)</label>
			<div class="controls">
				<?php echo $this->cbocapcongtrinh;?>
			</div>
		</div>
	</div>
</div>
