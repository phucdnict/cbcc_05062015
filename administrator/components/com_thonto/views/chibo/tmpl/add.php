...
<div class="control-group">
	<label class="control-label" for="ten">Tên  chi bộ<span style="color: red">(*)</span></label>
	<div class="controls">
...
<div class="control-group">
	<label class="control-label" for="donvi_id">UBND Phường/ Xã quản lý <span style="color: red">(*)</span></label>
	<div class="controls">
