...
class ThontoViewHinhthuckhenthuongkyluat extends JViewLegacy{
...
//	echo $user->id;
	...
	public function inputData(){
		...
		$data['table'] = 'thonto_hinhthuckhenthuongkyluat';
		$data['view'] = 'hinhthuckhenthuongkyluat';
		return $data;
	}
	...
	public function getDanhsach(){
		...
		$lists['status']	= JHTML::_('select.genericlist',array(
 		...
 		$model = JModelLegacy::getInstance('Hinhthuckhenthuongkyluat','ThontoModel');
