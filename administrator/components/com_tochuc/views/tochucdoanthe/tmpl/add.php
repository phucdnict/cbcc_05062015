...
<div class="control-group">
	<label class="control-label" for="name">Tên tổ chức đoàn thể <span style="color: red">(*)</span></label>
	<div class="controls">
...
<div class="control-group">
	...
	<div class="controls">
		<input type="text" id="orders" name="orders" class="validate-numeric" value="<?php echo $item['orders']; ?>" size="4" style="width:35px;"/>
	</div>
</div>
