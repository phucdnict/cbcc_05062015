<?php
class KekhaitaisanControllerCapcongtrinh extends JControllerLegacy {
	...
	function edit() {
		...
		JRequest::setVar ( 'view', 'Capcongtrinh' );
	...
	function cancel() {
		...
		$this->setRedirect ( 'index.php?option=com_kekhaitaisan&controller=Capcongtrinh', $msg );
	}
	function save() {
		...
		$link = 'index.php?option=com_kekhaitaisan&controller=Capcongtrinh';
