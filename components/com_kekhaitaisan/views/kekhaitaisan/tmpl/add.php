	...
	<!-- tài sản -->
						...
						<div class="nhaocongtrinh">
							<div class="row-fluid">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="nha_ten<?php echo $i;?>" name="nha_ten[]" class="width_max tentaisan" value="<?php echo $taisandb[$tsn]->value; ?>" placeholder="Nhập tên" />
		...
		?>
			<div class="widget-box "> <!-- collapsed nếu cần đóng-->
				...
				<div class="widget-body" >
					<span class="btn btn-success btn-small pull-right" title="Thêm mới" id_taisan="<?php echo $key ?>" id="insert_quyensudungdat_<?php echo $k;?>">Thêm mới</span>
					<br/>
							...
							<div class="quyensudungdat" >
								<div class="row-fluid">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" id="dat_ten" name="dat_ten[]" class="width_max dat_ten" value="<?php echo $taisandb[$ts]->value;?>" placeholder="Nhập tên" />
													...
													<div class="quyensudungdat" >
														<div class="row-fluid">
															...
															<div class="control-group">
																...
																<div class="controls">
																	<input type="text" id="dat_tennull" name="dat_ten[]" class="width_max dat_ten" placeholder="Nhập tên" />
																	<input type="hidden" value="<?php echo $key ?>" name="dat_taisan_id[]"/>
																</div>
															</div>
														</div>
		...
		<?php
			...
			case 0:
									...
									<div class="row-fluid">
										<div class="span4">
											<div class="control-group">
												...
												<div class="controls">
													<textarea rows="1" class="ts_phancap" id="tskts3_value<?php echo  $ts3;?>" name="tsk_value[<?php echo $data['id']?>][]" placeholder="Nhập tên tài sản" style="width: 200px;"><?php echo $taisandb[$ts3]->value;?></textarea>
												</div>
											</div>
										</div>
										<div class="span4">
				...
				<?php
								...
								jQuery(document).ready(function($){
									$('#tsk_value4<?php echo $ts4?>').on('change',function(){
										if ($('#tsk_value4<?php echo $ts4?>').val()!='') {
											...
											$("#trigia4<?php echo $data['id']?>").rules("add", { required: true, messages: { required: "Vui lòng nhập giá trị tài sản"}});
										}
										else {
									...
									$('#trigia4<?php echo $ts4?>').on('change',function(){
										if ($('#trigia4<?php echo $ts4?>').val()!='' || $('#trigia4<?php echo $ts4?>').val()!=0) {
											...
											$("#tsk_value4<?php echo $data['id']?>").rules("add", { required: true, messages: { required: "Vui lòng nhập giá trị tài sản"}});
										}
										else {
					...
					if($check==false){ // chưa có dữ liệu?>
						<div class="row-fluid">
							<div class="span4">
								<div class="control-group">
...
// 									$('#trigiaelse<php echo $data['id']?>').addClass('required');
									$("#trigiaelse<?php echo $data['id']?>").rules("add", { required: true, messages: { required: "Vui lòng nhập giá trị tài sản"}});
								}
								else {
...
// 									$('#trigiaelse<php echo $data['id']?>').removeClass('required');
									...
									$("#trigiaelse<?php echo $data['id']?>").rules("add", { required: false, messages: { required: "Vui lòng nhập giá trị tài sản"}});
								}
							});
...
// 									$('#tsk_valueelse<php echo $data['id']?>').addClass('required');
									$("#tsk_valueelse<?php echo $data['id']?>").rules("add", { required: true, messages: { required: "Vui lòng nhập tên tài sản"}});
								}
								else {
									$('#lbl_valueelse<?php echo $data['id']?>').html('Tên tài sản');
// 									$('#tsk_valueelse<php echo $data['id']?>').removeClass('required');
									$("#tsk_valueelse<?php echo $data['id']?>").rules("add", { required: false, messages: { required: "Vui lòng nhập giá trị tài sản"}});
								}
							});
						});
						</script>	
...
var nha_congtrinh = function(nhacongtrinh,id_taisan,loainhann,stt_nha){
	var loainha = <?php echo json_encode($loainha);?>;
    var cb_loainha = '<select id="nha_loainha_id'+id_taisan+stt_nha+'" name="nha_loainha_id[]" class="width_taisan_id chosen required">';
    ...
    var cb_capcongtrinh = '<select id="nha_capcongtrinh_id'+id_taisan+stt_nha+'" name="nha_capcongtrinh_id[]" class="width_taisan_id chosen required">';
	...
	str += '<label class="control-label" for="nha_ten'+id_taisan+stt_nha+'">'+nhacongtrinh+'(<span style="color:red;">*</span>)</label>';
	str += '<div class="controls">';
	str += '<input type="text" id="nha_ten'+id_taisan+stt_nha+'" name="nha_ten[]" class="width_max tentaisan" value="" placeholder="Nhập tên" />';
	...
	str += '<div class="span5">';
	str += '<div class="control-group">';
	str += '<label class="control-label" for="nha_loainha_id'+id_taisan+stt_nha+'">'+loainhann+'</label>';
	...
	str += '<div class="span5">';
	str += '<div class="control-group">';
	str += '<label class="control-label" for="name_capcongtrinh_id'+id_taisan+stt_nha+'">Cấp công trình</label>';
	...
	str += '<div class="span5">';
	str += '<div class="control-group">';
	str += '<label class="control-label" for="nha_dientich'+id_taisan+stt_nha+'">Diện tích xây dựng</label>';
	str += '<div class="controls">';
	str += '<input type="text" id="nha_dientich'+id_taisan+stt_nha+'" name="nha_dientich[]" class="" value="" placeholder="Nhập diện tích" />';
	str += '</div>';
	str += '</div>';
	str += '</div>';
	str += '<div class="span5">';
	str += '<div class="control-group">';
	str += '<label class="control-label" for="nha_giatri'+id_taisan+stt_nha+'">Giá trị</label>';
	str += '<div class="controls">';
	str += '<input type="text" id="nha_giatri'+id_taisan+stt_nha+'" class="money" style="text-align:right" name="nha_giatri[]" value="" placeholder="Nhập giá trị" />';
	str += '</div>';
	str += '</div>';
	str += '</div>';
	str += '</div>';
	str += '<div class="row-fluid">';
	str += '<div class="control-group">';
	str += '<label class="control-label" for="nha_gcn'+id_taisan+stt_nha+'">GCN quyền sở hữu</label>';
	str += '<div class="controls">';
	str += '<input type="text" id="nha_gcn'+id_taisan+stt_nha+'" name="nha_gcn[]" class="width_max" value="" placeholder="Nhập giấy chứng nhận quyền sở hữu" />';
	str += '</div>';
	str += '</div>';
	str += '</div>';
	str += '<div class="row-fluid">';
	...
	str += '<div class="controls">';
	str += '<input type="text" name="nha_thongtinkhac[]" class="width_max" value="" placeholder="Nhập thông tin khác" />';
	str += '</div>';
	str += '</div>';
	str += '</div>';
	str += '<div class="row-fluid">';
...
var quyensudungdat = function(nhacongtrinh, id_taisan, stt_dat){
	...
	str += '<div class="control-group">';
	str += '<label class="control-label" for="dat_ten'+id_taisan+stt_dat+'">'+nhacongtrinh+' (<span style="color:red;">*</span>)</label>';
	str += '<div class="controls">';
	str += '<input type="text" id="dat_ten'+id_taisan+stt_dat+'" name="dat_ten[]" class="width_max datten" value="" placeholder="Nhập tên" />';
	...
	str += '<div class="row-fluid">';
	str += '<div class="control-group">';
	str += '<label class="control-label" for="dat_diachi_'+id_taisan+stt_dat+'">Địa chỉ</label>';
	str += '<div class="controls">';
	str += '<input type="text" id="dat_diachi'+id_taisan+stt_dat+'" name="dat_diachi[]" class="width_max" value="" placeholder="Nhập địa chỉ" />';
	str += '</div>';
	str += '</div>';
	str += '</div>';
	str += '<div class="row-fluid">';
	str += '<div class="span5">';
	str += '<div class="control-group">';
	str += '<label class="control-label" for="dat_dientich_'+id_taisan+stt_dat+'">Diện tích xây dựng</label>';
	str += '<div class="controls">';
	str += '<input type="text" id="dat_dientich'+id_taisan+stt_dat+'" class="" name="dat_dientich[]" value="" placeholder="Nhập diện tích" />';
	str += '</div>';
	str += '</div>';
	str += '</div>';
	str += '<div class="span5">';
	str += '<div class="control-group">';
	str += '<label class="control-label" for="dat_giatri_'+id_taisan+stt_dat+'">Giá trị</label>';
	str += '<div class="controls">';
	str += '<input type="text" id="dat_giatri'+id_taisan+stt_dat+'" class="money" style="text-align:right" name="dat_giatri[]" value="" placeholder="Nhập giá trị" />';
	str += '</div>';
	str += '</div>';
	str += '</div>';
	str += '</div>';
	str += '<div class="row-fluid">';
	str += '<div class="control-group">';
	str += '<label class="control-label" for="dat_gcn'+id_taisan+stt_dat+'">GCN quyền sở hữu</label>';
	str += '<div class="controls">';
	str += '<input type="text" id="dat_gcn'+id_taisan+stt_dat+'" name="dat_gcn[]" class="width_max" value="" placeholder="Nhập giấy chứng nhận quyền sở hữu" />';
	str += '</div>';
	str += '</div>';
	str += '</div>';
	str += '<div class="row-fluid">';
...
// Insert nhà ở, công trình xây dựng
	var stt_nha =<?php echo $tmp_nha;?>;
	$("#insert_nha_congtrinh_1").click(function () {
		$('#nha_congtrinh_1').append(nha_congtrinh('Tên nhà', $(this).attr('id_taisan'),'Loại nhà', stt_nha));
		stt_nha = stt_nha +1;
		money();
		chosen();
	});
	var stt_dat = <?php echo $tmp_dat;?>;
	$("#insert_nha_congtrinh_2").click(function () {
		//nha_congtrinh();
		$('#nha_congtrinh_2').append(nha_congtrinh('Tên công trình', $(this).attr('id_taisan'),'Loại công trình',stt_nha));
		stt_nha = stt_nha +1;
		money();
		chosen();
	});
// 	Insert nhà ở, công trình xây dựng
	$("#insert_quyensudungdat_1").click(function () {
		$('#quyensudungdat_1').append(quyensudungdat('Tên mảnh đất', $(this).attr('id_taisan'),stt_dat));
		stt_dat = stt_dat +1;
		money();
	});
	$("#insert_quyensudungdat_2").click(function () {
		$('#quyensudungdat_2').append(quyensudungdat('Tên mảnh đất', $(this).attr('id_taisan'),stt_dat));
		stt_dat = stt_dat +1;
		money();
	});
// 	Insert con cái
	...
	$("body").delegate(".btn-xoa-concai", "click", function(event){
       	event.preventDefault();
           if(confirm('Bạn có chắc chắn muốn xóa?')){
   			$(this).parentsUntil(".div_concai_new").remove();
   			return false;
           }else{
               return false;
           }
...
// Insert phân cấp tài sản
    ...
    $("#insert_phancap_4").click(function () {
		...
		str +='<div class="controls">';
		str +='<textarea rows="1" class="ts_phancap" id="tsk4_value'+pc4+'" name="tsk_value[4][]" placeholder="Nhập tên tài sản" style="width: 200px;"></textarea>';
		str +='</div>';
		str +='</div>';
		str +='</div>';
		str +='<div class="span4">';
    ...
    $("#insert_phancap_5").click(function () {
		...
		str +='<div class="span4">';
		str +='<div class="control-group">';
		str +='<label  class="control-label" for="tsk5_value'+pc5+'">Tên tài sản (<span style="color:red;">*</span>)</label>';
		str +='<div class="controls">';
		str +='<textarea rows="1" class="ts_phancap" id="tsk5_value'+pc5+'" name="tsk_value[5][]" placeholder="Nhập tên tài sản" style="width: 200px;"></textarea>';
		str +='</div>';
		str +='</div>';
		str +='</div>';
		str +='<div class="span4">';
		str +='<div class="control-group">';
		str +='<label  class="control-label" for="tsk5_giatri'+pc5+'">Giá trị</label>';
		str +='<div class="controls">';
		str +='<textarea rows="1" class="money" style="text-align:right" id="tsk5_giatri'+pc5+'" name="tsk_giatri[5][]" placeholder="Nhập giá trị tài sản" style="width: 300px;"></textarea>';
		str +='</div>';
		str +='</div>';
		str +='</div>';
		str +='</div>';
...
// Lưu tiếp tục
    ...
    invalidHandler: function(form, validator) {
			...
			if (errors) {
				var message = errors == 1 ? 'Kiểm tra lỗi sau:<br/>' : 'Phát hiện các lỗi sau:<br/>';
				var errors = "";
   	...
   	$(".tentaisan").rules("add", { required: true, messages: { required: "Vui lòng nhập tên tài sản"}});
   	$(".dat_ten").rules("add", { required: true, messages: { required: "Vui lòng nhập tên tài sản"}});
   	$(".ts_phancap").rules("add", { required: true, messages: { required: "Vui lòng nhập tên tài sản"}});
