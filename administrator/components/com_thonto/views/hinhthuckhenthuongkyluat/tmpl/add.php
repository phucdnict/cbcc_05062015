...
<div class="control-group">
	<label class="control-label" for="ten">Tên hình thức<span style="color: red">(*)</span></label>
	<div class="controls">
...
<div class="control-group">
	<label class="control-label" for="loai">Khen thưởng/ Kỷ luật <span style="color: red">(*)</span></label>
	<div class="controls">
		<select name="loai" id="loai" class="required">
			<option value="0" <?php if ($item['loai']==0) echo 'selected="selected"';?>>Khen thưởng</option>
			<option value="1" <?php if ($item['loai']==1) echo 'selected="selected"';?>>Kỷ luật</option>
		</select>
	</div>
</div>
