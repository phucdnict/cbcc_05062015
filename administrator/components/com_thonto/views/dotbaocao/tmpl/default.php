...
<tr>
	...
	<th style="text-align: center;vertical-align:middle;" nowrap="nowrap">
		<?php echo JHTML::_('grid.sort', 'Tên đợt báo cáo', 'tendot', $this->lists['order_Dir'], $this->lists['order'] ); ?>
	</th>
	<th style="text-align: center;vertical-align:middle;" nowrap="nowrap" width="100">
		<?php echo JHTML::_('grid.sort', 'Năm báo cáo', 'nam', $this->lists['order_Dir'], $this->lists['order'] ); ?>
	</th>
	<th style="text-align: center;vertical-align:middle;" nowrap="nowrap" width="100">
		Trạng thái
	</th>
...
for($i=0, $n=count($this->items); $i<$n; $i++){
	...
	$link_remove = JRoute::_('index.php?option=com_thonto&controller='.$this->data['view'].'&task=remove&dbtable='.$this->data['table'].'&id='.$row->id);
	$link_fk = JRoute::_('index.php?option=com_thonto&controller='.$this->data['view'].'&task=configdot&id='. $row->id );
...
<tr class="<?php echo "row$k"; ?>">
	...
	<td style="vertical-align:middle;">
		<a  href="<?php echo $link_edit; ?>" title="Chỉnh sửa">
				<?php echo htmlspecialchars($row->tendot); ?>
			</a>
	</td>
	<td style="vertical-align:middle;">
			<?php echo $row->nam; ?>
	...
	<td style="text-align: center;vertical-align:middle;">
		<div class="btn-group">
			...
			<a class="btn btn-small btn-info hasTooltip" href="<?php echo $link_fk;?>" title="Cấu hình">
				<i class="icon-cog"></i>
			</a>
		</div>
	</td>
