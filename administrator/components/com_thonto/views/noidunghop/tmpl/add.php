...
<div class="control-group">
	<label class="control-label" for="ten">Tên nội dung họp<span style="color: red">(*)</span></label>
	<div class="controls">
		<input type="text" id="ten" name="ten" class="required" value="<?php echo $item['ten']; ?>" placeholder="Nhập tên" />
	</div>
</div>
<div class="control-group">
	<label class="control-label" for="sapxep">Sắp xếp</span></label>
	<div class="controls">
		<input type="text" id="sapxep" name="sapxep" class="number" value="<?php if (isset($item['sapxep'])) echo $item['sapxep'];else echo '99'; ?>" placeholder="Nhập tên" />
	</div>
</div>
...
<input type="hidden" name="controller" value="noidunghop" />
</form>
