...
class ThongkeViewBcdaotaocc extends JViewLegacy {
 ...
 public function doituong(){
 	...
 	$tungay 		=	$_POST['tungay_bcdaotaocc'];
 	$denngay 		=	$_POST['denngay_bcdaotaocc'];
 	$target			=	$_POST['target'];
 ...
 public function baocao(){
 	...
 	$idRoot = Core::getManageUnit($idUser, 'com_thongke', 'treeview', 'treebcdaotaocc');
 	if($idRoot == null){
