 ...
 * @ Author: Phucnh
 * @ Date: Aug 12, 2015
 * @ File_name: Chucvu.php
 */
defined('_JEXEC') or die('Restricted access');
class ThontoModelChucvu extends JModelList{
	var $_data = null;
	var $_total = null;
	...
	public function _buildContentOrderBy(){
		...
		$filter_order		= $this->mainframe->getUserStateFromRequest( $this->option.'filter_order','filter_order','','name','cmd' );
		$filter_order_Dir	= $this->mainframe->getUserStateFromRequest( $this->option.'filter_order_Dir','filter_order_Dir',	'',	'word' );
		if (!in_array($filter_order, array('loaihinhtochuc_id', 'name'))){
			$filter_order = 'loaihinhtochuc_id';
		}
		...
		if ($filter_order != 'loaihinhtochuc_id'){
	...
	public function storeData(){
		...
		$object = new stdClass();
		$object->ten = $data['ten'];
		$object->loaihinhtochuc_id = $data['loaihinhtochuc_id'];
		$object->sothangbonhiem = $data['sothangbonhiem'];
