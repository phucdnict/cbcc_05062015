...
<div class="control-group">
	<label class="control-label" for="ten">Tên chức vụ<span style="color: red">(*)</span></label>
	<div class="controls">
...
<div class="control-group">
	<label class="control-label" for="loaihinhtochuc_id">Loại hình tổ chức <span style="color: red">(*)</span></label>
	<div class="controls">
		<?php echo $this->loaihinhtochuc_id;?>
	</div>
</div>

<div class="control-group">
	<label class="control-label" for="sothangbonhiem">Số tháng bổ nhiệm</span></label>
	<div class="controls">
		<input type="text" id="sothangbonhiem" name="sothangbonhiem" class="number" value="<?php echo $item['sothangbonhiem']; ?>" placeholder="Nhập tên" />
	</div>
</div>
