...
// echo $model->hienthi('154371');
?>
<div id="tab_abc" class="tab-pane active">
	<div>
		<h5 class="header smaller lighter blue">
			<?php echo $this->root_info['root_name']?>
			<span class="pull-right inline">
				<a data-original-title="Thêm mới" class="btn btn-small btn-primary" id="btn_hienthi_bcdaotaocc" style="margin-right: 5px;" data-toggle="modal" data-target=".modal">
					<i class="icon-search"></i> Hiển thị
				</a>
				<span data-original-title="Xóa" class="btn btn-small btn-success" id="btn_excel_bcdaotaovc" style="margin-right: 5px;" data-placement="top" title="">
	...
	<div class="row-fluid">
	   	<div class="span4">
	   		<div id="caydonvi_bcdaotaocc" style="overflow:auto; height: 200px;"> CÂY ĐƠN VỊ </div>
	    </div>
	   	<div class="span8">
	   		<h4 style="text-align:center;" class="blue header"><i class="icon-star blue"></i> Báo cáo đào tạo bồi dưỡng công chức</h4>
	   		<div class="row-fluid">
					...
					<div class="widget-box transparent">
						...
						<div class="widget-body">
							<div class="widget-main padding-6">
								<div>
									<h5>
										Từ <input style="width:85px" name="tungay_bcdaotaocc" value="<?php echo date("d/m/Y")?>" id="tungay_bcdaotaocc" class="date mask"> 
										đến <input style="width:85px" name="denngay_bcdaotaocc" value="<?php echo date("d/m/Y")?>" id="denngay_bcdaotaocc" class="date mask">
									</h5>
								</div>
							</div>
						</div>
...
var text = function(txt, data){
	var dt= txt+'<td style="text-align:center;">'+data.caocap_ctri+'</td><td style="text-align:center;">'+data.trungcap_ctri+'</td><td style="text-align:center;">'+data.socap_ctri+'</td><td style="text-align:center;">'+data.cunhan_ctri+'</td><td style="text-align:center;">'+data.qlnn_cvcc+'</td>';
...
jQuery(document).ready(function($){
		   ...
		   "types" : {
		    ...
		    "default" : {
		    	"check_node" : function (node) {
		        	$('#caydonvi_bcdaotaocc').jstree('uncheck_all');
		            return true;
		          },
	...
	$('#tungay_bcdaotaocc').on('change', function(){
		var a_arr 		= ($("#denngay_bcdaotaocc").val()).split('/');
        var b_arr 		= ($(this).val()).split('/');
        var start 	= a_arr[2]+a_arr[1]+a_arr[0];
	     var end	= b_arr[2]+b_arr[1]+b_arr[0];
	     var tmp = start - end;
	     if(($("#denngay_bcdaotaocc").val()!="")  && $(this).val()!=""){
		     if (tmp>=0) {}
		     else {alert('Thời gian không hợp lệ'); $(this).val("");}
	     } 
	});
	$('#denngay_bcdaotaocc').on('change', function(){
		var a_arr 		= ($("#tungay_bcdaotaocc").val()).split('/');
        var b_arr 		= ($(this).val()).split('/');
        var start 	= a_arr[2]+a_arr[1]+a_arr[0];
	     var end	= b_arr[2]+b_arr[1]+b_arr[0];
	     var tmp = start - end;
	     if(($("#tungay_bcdaotaocc").val()!="")  && $(this).val()!=""){
		     if (tmp<=0) {}
		     else {alert('Thời gian không hợp lệ'); $(this).val("");}
	     }  
	});
	...
	$('#module-left').hide();
	$('#btn_hienthi_bcdaotaocc').on('click', function(){
		var donvi_id_checked;
		$("#caydonvi_bcdaotaocc").jstree("get_checked",null,true).each(function () {
			donvi_id_checked= this.id.replace("node_","");
    	});
    	if(donvi_id_checked>0){
			var tungay_bcdaotaocc = $('#tungay_bcdaotaocc').val();
			var denngay_bcdaotaocc = $('#denngay_bcdaotaocc').val();
			if (tungay_bcdaotaocc!=null || tungay_bcdaotaocc!="" || denngay_bcdaotaocc!=null || denngay_bcdaotaocc!=""){
				var str='';
				...
				str +='</tr>';
				str +='<tr style="background: #ECECEC;">';
				str +='<th>Cao cấp</th><th>Trung cấp</th><th>Sơ cấp</th><th>Bồi dưỡng</th>';
...
// 				str +='<tr id="dtall"></tr>';
		        ...
		        $.ajax({
					type: 'POST',
		  			url: '<?php echo JUri::base(true);?>/index.php?option=com_thongke&view=bcdaotaocc&format=raw&task=doituong',
		  			data: { donvi_id : donvi_id_checked, tungay_bcdaotaocc:tungay_bcdaotaocc, denngay_bcdaotaocc:denngay_bcdaotaocc, target:1 ,condition:1},
		        ...
		        $.ajax({
					type: 'POST',
		  			url: '<?php echo JUri::base(true);?>/index.php?option=com_thongke&view=bcdaotaocc&format=raw&task=doituong',
		  			data: { donvi_id : donvi_id_checked, tungay_bcdaotaocc:tungay_bcdaotaocc, denngay_bcdaotaocc:denngay_bcdaotaocc, target:1 ,condition:2},
		  			success:function(data){
		        ...
		        $.ajax({
					type: 'POST',
		  			url: '<?php echo JUri::base(true);?>/index.php?option=com_thongke&view=bcdaotaocc&format=raw&task=doituong',
		  			data: { donvi_id : donvi_id_checked, tungay_bcdaotaocc:tungay_bcdaotaocc, denngay_bcdaotaocc:denngay_bcdaotaocc, target:1 ,condition:3},
		  			success:function(data){
		        ...
		        $.ajax({
					type: 'POST',
		  			url: '<?php echo JUri::base(true);?>/index.php?option=com_thongke&view=bcdaotaocc&format=raw&task=doituong',
		  			data: { donvi_id : donvi_id_checked, tungay_bcdaotaocc:tungay_bcdaotaocc, denngay_bcdaotaocc:denngay_bcdaotaocc, target:1 ,condition:4},
		  			success:function(data){
		        ...
		        $.ajax({
					type: 'POST',
		  			url: '<?php echo JUri::base(true);?>/index.php?option=com_thongke&view=bcdaotaocc&format=raw&task=doituong',
		  			data: { donvi_id : donvi_id_checked, tungay_bcdaotaocc:tungay_bcdaotaocc, denngay_bcdaotaocc:denngay_bcdaotaocc, target:2 ,condition:1},
		  			success:function(data){
		        ...
		        $.ajax({
					type: 'POST',
		  			url: '<?php echo JUri::base(true);?>/index.php?option=com_thongke&view=bcdaotaocc&format=raw&task=doituong',
		  			data: { donvi_id : donvi_id_checked, tungay_bcdaotaocc:tungay_bcdaotaocc, denngay_bcdaotaocc:denngay_bcdaotaocc, target:2 ,condition:2},
		  			success:function(data){
		        ...
		        $.ajax({
					type: 'POST',
		  			url: '<?php echo JUri::base(true);?>/index.php?option=com_thongke&view=bcdaotaocc&format=raw&task=doituong',
		  			data: { donvi_id : donvi_id_checked, tungay_bcdaotaocc:tungay_bcdaotaocc, denngay_bcdaotaocc:denngay_bcdaotaocc, target:2 ,condition:3},
		  			success:function(data){
		        ...
		        $.ajax({
					type: 'POST',
		  			url: '<?php echo JUri::base(true);?>/index.php?option=com_thongke&view=bcdaotaocc&format=raw&task=doituong',
		  			data: { donvi_id : donvi_id_checked, tungay_bcdaotaocc:tungay_bcdaotaocc, denngay_bcdaotaocc:denngay_bcdaotaocc, target:2 ,condition:4},
		  			success:function(data){
		        ...
		        $.ajax({
					type: 'POST',
		  			url: '<?php echo JUri::base(true);?>/index.php?option=com_thongke&view=bcdaotaocc&format=raw&task=doituong',
		  			data: { donvi_id : donvi_id_checked, tungay_bcdaotaocc:tungay_bcdaotaocc, denngay_bcdaotaocc:denngay_bcdaotaocc, target:4 ,condition:1},
		  			success:function(data){
		        ...
		        $.ajax({
					type: 'POST',
		  			url: '<?php echo JUri::base(true);?>/index.php?option=com_thongke&view=bcdaotaocc&format=raw&task=doituong',
		  			data: { donvi_id : donvi_id_checked, tungay_bcdaotaocc:tungay_bcdaotaocc, denngay_bcdaotaocc:denngay_bcdaotaocc, target:4 ,condition:2},
		  			success:function(data){
		        ...
		        $.ajax({
					type: 'POST',
		  			url: '<?php echo JUri::base(true);?>/index.php?option=com_thongke&view=bcdaotaocc&format=raw&task=doituong',
		  			data: { donvi_id : donvi_id_checked, tungay_bcdaotaocc:tungay_bcdaotaocc, denngay_bcdaotaocc:denngay_bcdaotaocc, target:4 ,condition:3},
		  			success:function(data){
		        ...
		        $.ajax({
					type: 'POST',
		  			url: '<?php echo JUri::base(true);?>/index.php?option=com_thongke&view=bcdaotaocc&format=raw&task=doituong',
		  			data: { donvi_id : donvi_id_checked, tungay_bcdaotaocc:tungay_bcdaotaocc, denngay_bcdaotaocc:denngay_bcdaotaocc, target:5 ,condition:1},
		  			success:function(data){
		        ...
		        $.ajax({
					type: 'POST',
		  			url: '<?php echo JUri::base(true);?>/index.php?option=com_thongke&view=bcdaotaocc&format=raw&task=doituong',
		  			data: { donvi_id : donvi_id_checked, tungay_bcdaotaocc:tungay_bcdaotaocc, denngay_bcdaotaocc:denngay_bcdaotaocc, target:5 ,condition:2},
		  			success:function(data){
		        ...
		        $.ajax({
					type: 'POST',
		  			url: '<?php echo JUri::base(true);?>/index.php?option=com_thongke&view=bcdaotaocc&format=raw&task=doituong',
		  			data: { donvi_id : donvi_id_checked, tungay_bcdaotaocc:tungay_bcdaotaocc, denngay_bcdaotaocc:denngay_bcdaotaocc, target:6 ,condition:3},
		  			success:function(data){
...
// 					type: 'POST',
// 		  			url: '<php echo JUri::base(true);?>/index.php?option=com_thongke&view=bcdaotaocc&format=raw&task=doituong',
// 		  			data: { donvi_id : donvi_id_checked, tungay_bcdaotaocc:tungay_bcdaotaocc, denngay_bcdaotaocc:denngay_bcdaotaocc,target:0 },
// 		  			success:function(data){
...
// 		        });
	...
	$('#btn_excel_bcdaotaovc').on('click', function(){
		var checked_ids = [];
		$("#caydonvi_bcdaotaocc").jstree("get_checked",null,true).each(function () {
		...
		if(checked_ids.length>0){
			var tungay_bcdaotaocc = $('#tungay_bcdaotaocc').val();
			var denngay_bcdaotaocc = $('#denngay_bcdaotaocc').val();
			url= '<?php echo JUri::base(true);?>/index.php?option=com_thongke&view=bcdaotaocc&format=xls&donvi_id='+checked_ids+'&tungay_bcdaotaocc='+tungay_bcdaotaocc+'&denngay_bcdaotaocc='+denngay_bcdaotaocc;
