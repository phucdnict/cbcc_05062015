...
var refreshData = function (){
	...
	jQuery.ajax({
	    ...
	    success: function(data) {
		    ...
		    xhtml+= '<th style="vertical-align: middle; width:100px" class="center">Ngày đăng ký<br/><input class="datepicker" style="width:70px; background-color: #f1f1f1" id="min_date"><input style="width:70px;  background-color: #f1f1f1"class="datepicker" id="max_date"></th>';
			...
			if(showlist != '2'){
				if(showlist == 1 || showlist == 3 || showlist == 0){
					refreshData();
	 				...
	 				$('#tabNhucaudaotao').html('');
	 			}
			}else {data.inst.toggle_node(data.rslt.obj);$('#tabNhucaudaotao').html('');}
		 });
