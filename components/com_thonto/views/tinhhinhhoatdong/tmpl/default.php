...
<h3 class="row-fluid header smaller lighter blue">
	Tình hình hoạt động <small><span id='tentochuc'></span> </small>
	<span class="pull-right inline">
		<?php echo $model->selectBox($dot,array('name'=>'dot'),'thonto_dotbaocao', array('id', 'tendot'),'trangthai=1', 'nam desc');?>
	</span>
</h3>
...
var _initViewDetailPage = function(id){
	...
	jQuery.ajax({
		  type: "GET",
		  url: 'index.php?option=com_thonto&controller=tinhhinhhoatdong&task=frmtinhhinhhoatdong&format=raw&thonto_id='+id+'&dot='+dot,
		  beforeSend: function(){
			  jQuery.blockUI();
...
//		    real_checkboxes: true,
	...
	$('body').delegate('.btn_xoa_kiennghi','click', function(){
