	...
	public function duthao($idHoso, $type){
		if ($type =='nltx' || $type == 'nltth') 
			$data = $this->xuatduthao($idHoso, 
										...
										dvcq.name as donvichuquan,dvcq.id as donvichuquan_id,
										dv.ins_loaihinh, 
		...
		elseif ($type =='dd' || $type == 'bn' || $type == 'bnvnvc' || $type == 'cxnl' || $type == 'dttn' || $type == 'dtnn' || $type=='gqtv' || $type == 'kl' || $type=='kt' )
			$data = $this->xuatduthao($idHoso, 
					"dvcq.id as donvichuquan_id,dvcq.name as donvichuquan, hsc.birth_place, hs.luong_bac, hs.luong_heso,
