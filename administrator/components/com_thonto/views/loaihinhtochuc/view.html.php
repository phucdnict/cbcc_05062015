...
class ThontoViewLoaihinhtochuc extends JViewLegacy{
...
//	echo $user->id;
	...
	public function inputData(){
		...
		$data['table'] = 'thonto_loaihinhtochuc';
		$data['view'] = 'loaihinhtochuc';
		return $data;
	}
	...
	public function getDanhsach(){
		...
		$lists['status']	= JHTML::_('select.genericlist',array(
 		...
 		$model = JModelLegacy::getInstance('Loaihinhtochuc','ThontoModel');
