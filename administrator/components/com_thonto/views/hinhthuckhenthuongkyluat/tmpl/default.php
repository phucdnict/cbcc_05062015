...
<tr>
	...
	<th style="text-align: center;vertical-align:middle;" nowrap="nowrap">
		<?php echo JHTML::_('grid.sort', 'Tên hình thức', 'ten', $this->lists['order_Dir'], $this->lists['order'] ); ?>
	</th>
	<th style="text-align: center;vertical-align:middle;" nowrap="nowrap" width="100">
		<?php echo JHTML::_('grid.sort', 'Hình thức', 'loai', $this->lists['order_Dir'], $this->lists['order'] ); ?>
	</th>
	<th style="text-align: center;vertical-align:middle;" nowrap="nowrap" width="100">
		Trạng thái
	</th>
...
<tr class="<?php echo "row$k"; ?>">
	...
	<th style="text-align: left;vertical-align:middle;" nowrap="nowrap" width="100">
		<?php if ($row->loai ==0) echo 'Khen thưởng'; elseif($row->loai ==1) echo 'Kỷ luật' ?>
	</th>
	<td style="text-align: center;vertical-align:middle;">
		<?php 
			if($row->trangthai == '1'){
...
<input type="hidden" name="controller" value="hinhthuckhenthuongkyluat" />
