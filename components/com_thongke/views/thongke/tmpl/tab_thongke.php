...
jQuery(document).ready(function($){
	...
	var url1 = $('a[href="#congchuc_tapsu_bonhiemngach"]').attr('data-tab-url');
	$('#congchuc_tapsu_bonhiemngach').load(url1, function(){
		$(this).addClass('active');
		$('a[href="#congchuc_tapsu_bonhiemngach').closest( "li" ).addClass('active');
		$.unblockUI();
	});
	$('#tabs-thongke a:first').load($(this).find('a').data('tab-url'), function(){});
});
</script>