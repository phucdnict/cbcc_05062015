...
<tr>
	...
	<th style="text-align: center;vertical-align:middle;" nowrap="nowrap">
		<?php echo JHTML::_('grid.sort', 'Tên nhóm chức vụ', 'ten', $this->lists['order_Dir'], $this->lists['order'] ); ?>
	</th>
...
for($i=0, $n=count($this->items); $i<$n; $i++){
	...
	$link_remove = JRoute::_('index.php?option=com_thonto&controller=loaihinhtochuc&controller='.$this->data['view'].'&task=remove&dbtable='.$this->data['table'].'&id='.$row->id);
...
<input type="hidden" name="controller" value="loaihinhtochuc" />
