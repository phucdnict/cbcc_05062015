...
<?php endif;?>
	<div class="span4">
	<fieldset>
	<legend>Gói hình thức hưởng lương
...
<table class="table table-striped table-bordered table-hover">
			...
			for ($i = 0; $i < count($this->items); $i++) {
				...
				<tr>
					...
					<td nowrap="nowrap">						
						<a href="index.php?option=com_tochuc&controller=goihinhthuchuongluong&task=delete&id=<?php echo $item['id'];?>" class="btn btn-danger btn-mini"><i class="icon-trash"></i></a>
					</td>
				</tr>
				<?php 
			} 
...
jQuery(document).ready(function($){
	var _initEditPage = function(id){
		$.get('index.php?option=com_tochuc&controller=goihinhthuchuongluong&task=edit&format=raw',{"id":id},function(response){
