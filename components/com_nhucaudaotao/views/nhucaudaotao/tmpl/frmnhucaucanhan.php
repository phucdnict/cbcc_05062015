...
jQuery(document).ready(function($){
	$('#nhucaudaotaoFrm').validate({
		...
		messages: {
			'id_loaitrinhdo': {
				required: "<b>Loại trình độ</b> bắt buộc nhập",
			},
			'id_chuyennganh': {
				required: "<b>Chuyên ngành</b> bắt buộc nhập",
			},
			'id_trinhdo': {
				required: "<b>Trình độ</b> bắt buộc nhập",
			},
			'name_chuyennganh': {
				required: "<b>Chuyên ngành</b> bắt buộc nhập",
			},
		...
		submitHandler: function(){
			...
			$.post(url, data_nhucaudaotaoFrm, function(data){
					...
					else if (data==2) {loadNoticeBoardError('Thông báo','CBCC đã được đào tạo trình độ này. Vui lòng chọn trình độ khác.');$.unblockUI();}
					else {loadNoticeBoardError('Thông báo','Có lỗi xảy ra, vui lòng liên hệ quản trị viên.');$.unblockUI();}
			});
