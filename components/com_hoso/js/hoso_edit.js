...
var showBaohiem = function(ngaybatdau,ngayketthuc,thongtindiengiai,hesoluong,loaiphucap,hesophucap,tyledongbhxh_donvi,tyledongbhxh_canhan,tongtiendong){
	if(ngaybatdau == null){
		ngaybatdau = '';
	}
	if(ngayketthuc == null){
	...
	if(tyledongbhxh_donvi == null){
		tyledongbhxh_donvi = '';
	}
	if(tyledongbhxh_canhan == null){
		tyledongbhxh_canhan = '';
	}
	if(tongtiendong == null){
		tongtiendong = '';
	}
	var maukekhaibhxh_id = jQuery('#maukekhaibhxh_id').val();
	if(maukekhaibhxh_id == null || maukekhaibhxh_id == ''){
		jQuery('.div_bhxh_ngaybatdau').hide();
		jQuery('.div_bhxh_ngayketthuc').hide();
		jQuery('.div_bhxh_thongtindiengiai').hide();
		jQuery('.div_bhxh_hesoluong').hide();
		jQuery('.div_bhxh_loaiphucap').hide();
		jQuery('.div_bhxh_hesophucap').hide();
		jQuery('.div_bhxh_tyledongbhxh_donvi').hide();
		jQuery('.div_bhxh_tyledongbhxh_canhan').hide();
		jQuery('.div_bhxh_tongtiendong').hide();
	}else{
		var option_selected = jQuery('#maukekhaibhxh_id').find('option:selected');
		if(option_selected.data('text_ngaybatdau') != null && option_selected.data('text_ngaybatdau') != '' ){
			jQuery('#lbl_bhxh_ngaybatdau').html(option_selected.data('text_ngaybatdau') + ' (<span style="color:red;">*</span>)');
			jQuery('#ngaybatdau').val(ngaybatdau);
			jQuery('.div_bhxh_ngaybatdau').show();
		}else{
			jQuery('#ngaybatdau').val('');
			jQuery('.div_bhxh_ngaybatdau').hide();
		}
		if(option_selected.data('text_ngayketthuc') != null && option_selected.data('text_ngayketthuc') != '' ){
			jQuery('#lbl_bhxh_ngayketthuc').html(option_selected.data('text_ngayketthuc') + ' (<span style="color:red;">*</span>)');
			jQuery('#ngayketthuc').val(ngayketthuc);
			jQuery('.div_bhxh_ngayketthuc').show();
		}else{
			jQuery('#ngayketthuc').val('');
			jQuery('.div_bhxh_ngayketthuc').hide();
		}
		if(option_selected.data('text_thongtindiengiai') != null && option_selected.data('text_thongtindiengiai') != '' ){
			jQuery('#lbl_bhxh_thongtindiengiai').html(option_selected.data('text_thongtindiengiai') + ' (<span style="color:red;">*</span>)');
			jQuery('#thongtindiengiai').val(thongtindiengiai);
			jQuery('.div_bhxh_thongtindiengiai').show();
		}else{
			jQuery('#thongtindiengiai').val('');
			jQuery('.div_bhxh_thongtindiengiai').hide();
		}
		if(option_selected.data('text_hesoluong') != null && option_selected.data('text_hesoluong') != '' ){
			jQuery('#lbl_bhxh_hesoluong').html(option_selected.data('text_hesoluong') + ' (<span style="color:red;">*</span>)');
			jQuery('#hesoluong').val(hesoluong);
			jQuery('.div_bhxh_hesoluong').show();
		}else{
			jQuery('#hesoluong').val('');
			jQuery('.div_bhxh_hesoluong').hide();
		}
		if(option_selected.data('text_loaiphucap') != null && option_selected.data('text_loaiphucap') != '' ){
			jQuery('#lbl_bhxh_loaiphucap').html(option_selected.data('text_loaiphucap'));
			jQuery('#loaiphucap').val(loaiphucap);
			jQuery('.div_bhxh_loaiphucap').show();
		}else{
			jQuery('#loaiphucap').val('');
			jQuery('.div_bhxh_loaiphucap').hide();
		}
		if(option_selected.data('text_hesophucap') != null && option_selected.data('text_hesophucap') != '' ){
			jQuery('#lbl_bhxh_hesophucap').html(option_selected.data('text_hesophucap'));
			jQuery('#hesophucap').val(hesophucap);
			jQuery('.div_bhxh_hesophucap').show();
		}else{
			jQuery('#hesophucap').val('');
			jQuery('.div_bhxh_hesophucap').hide();
		}
		if(option_selected.data('text_tyledongbhxh_donvi') != null && option_selected.data('text_tyledongbhxh_donvi') != '' ){
			jQuery('#lbl_bhxh_tyledongbhxh_donvi').html(option_selected.data('text_tyledongbhxh_donvi') + ' (<span style="color:red;">*</span>)');
			jQuery('#tyledongbhxh_donvi').val(tyledongbhxh_donvi);
			jQuery('.div_bhxh_tyledongbhxh_donvi').show();
		}else{
			jQuery('#tyledongbhxh_donvi').val('');
			jQuery('.div_bhxh_tyledongbhxh_donvi').hide();
		}
		if(option_selected.data('text_tyledongbhxh_canhan') != null && option_selected.data('text_tyledongbhxh_canhan') != '' ){
			jQuery('#lbl_bhxh_tyledongbhxh_canhan').html(option_selected.data('text_tyledongbhxh_canhan') + ' (<span style="color:red;">*</span>)');
			jQuery('#tyledongbhxh_canhan').val(tyledongbhxh_canhan);
			jQuery('.div_bhxh_tyledongbhxh_canhan').show();
		}else{
			jQuery('#tyledongbhxh_canhan').val('');
			jQuery('.div_bhxh_tyledongbhxh_canhan').hide();
		}
		if(option_selected.data('text_tongtiendong') != null && option_selected.data('text_tongtiendong') != '' ){
			jQuery('#lbl_bhxh_tongtiendong').html(option_selected.data('text_tongtiendong') + ' (<span style="color:red;">*</span>)');
			jQuery('#tongtiendong').val(tongtiendong);
			jQuery('.div_bhxh_tongtiendong').show();
		}else{
			jQuery('#tongtiendong').val('');
			jQuery('.div_bhxh_tongtiendong').hide();
		}
	}
};
...
jQuery(document).ready(function($){
	...
	$('body').delegate('.btn_save_bchd', 'click', function(){
		...
		if($('#BiencheFrm').valid() == false){
			...
			if(compareDate($('#bc_ngaybatdau').val(),bc_ngaybatdau_bchd) >= 0 && $.inArray($('#bc_hinhthuc_id').val(),arrGoibienche) == -1){
				...
				$.post(url, $('#BiencheFrm').serialize(), function(data){
					if(data == '1'){
						...
						if(compareDate($('#bc_ngaybatdau').val(),bc_ngaybatdau_bchd) >= 0){
	...
	$('body').delegate('.btn_save_congtac', 'click', function(){
		...
		if($('#CongtacFrm').valid() == false){
			...
			var ngaycongtac = $('#start_date_ct').val();
			$.post(url_ngaycongtac, { ngaycongtac : ngaycongtac },function(data){
				if(data == '0'){
					loadNoticeBoardError('Thông báo','Ngày bắt đầu công tác phải nhỏ hơn hoặc bằng ngày hiện tại.');
					$.unblockUI();
					return false;
				}else{
	...
	$('body').delegate('#type_knbp', 'change', function(){
		if($('#type_knbp').val() != ''){
			$('.div_knbp').show();
			$('.div_knbp_chucvu').find('label').html('Chức vụ (<span style="color:red;">*</span>)');
			if($('#type_knbp').val() == '2'){
				$('.div_knbp_chucvu').find('label').html('Chức vụ');
//				$('#pos_sys_knbp').val('');
//				$('#pos_name_knbp').val('');
			}
		}else{
				...
				if(data == '1'){
					...
					$.ajax({
						...
						success:function(data){
							...
							renewElement($('#lbl_coban_luongmoi'),data.lbl_coban_luongmoi);
							renewElement($('#lbl_tongthunhap_luongmoi'),data.lbl_tongthunhap_luongmoi);
						}
					});
					$('#modalQuatrinh').modal('hide');
					$('#noidung_quatrinh').html('');
	...
	$('body').delegate('#tosc_code_dt_nghiepvu', 'change', function(){
		...
		if(is_chuyennganh != '1'){
			$.ajax({
				...
				data: { loaitrinhdo:loaitrinhdo, is_chuyennganh : is_chuyennganh },
				success:function(data){
			...
			$.ajax({
				...
				success:function(data){
					...
					$('#lim_code_dt_nghiepvu').html(str);
					$('#lim_code_dt_nghiepvu').change();
				}
			});
			$('.div_CNDTNV').show();
	...
	$('body').delegate('#maukekhaibhxh_id','change',function(){
		showBaohiem();
	});
