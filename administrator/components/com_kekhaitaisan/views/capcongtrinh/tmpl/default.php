...
$items=$this->items;
?>
<form action="<?php echo JRoute::_('index.php?option=com_kekhaitaisan&controller=capcongtrinh'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
	        ...
	        for ($i=0, $n = count( $items ); $i < $n; $i++)
	        {
	            ...
	            $link 		= JRoute::_( 'index.php?option=com_kekhaitaisan&controller=capcongtrinh&task=edit&id='.$row->id );
    ...
    <input type="hidden" name="view" value="capcongtrinh" />
    </div>
    </div>
</form>
<script>
