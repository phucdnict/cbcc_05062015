...
class ThontoViewNoidunghop extends JViewLegacy{
...
//	echo $user->id;
	...
	public function inputData(){
		...
		$data['table'] = 'thonto_danhmucnoidunghop';
		$data['view'] = 'noidunghop';
		return $data;
	}
	...
	public function getDanhsach(){
		...
		$lists['status']	= JHTML::_('select.genericlist',array(
 		...
 		$model = JModelLegacy::getInstance('Noidunghop','ThontoModel');
